...
### （一）工作項目總覽
共分 9 個主要活動（T1~T9）。時程預留 1–2 週緩衝。

| WBS | 任務名稱 | 開始 | 結束 | 備註 |
|-----|-----------|------|------|------|
| T1.1 | 需求分析 | 114/10/1 | 114/10/14 | 與設計分析可平行 |
| T1.2 | 設計規格分析 | 114/10/10 | 114/11/10 | 制定 ER / API 結構 |
| T1.3 | V&V 測試規格 | 114/11/1 | 114/12/16 | 持續更新測試文件 |
| T2.1 | 前端 UI | 114/10/9 | 114/10/20 | 介面框架建立 |
| T2.2 | 後端資料庫 | 114/10/9 | 114/10/20 | 配合前端初期介面 |
| T2.3 | 用戶系統 | 114/10/20 | 114/10/30 | 與意見系統平行 |
| T2.4 | 意見系統 | 114/10/25 | 114/11/10 | 與瀏覽系統重疊 |
| T2.5 | 瀏覽系統 | 114/11/1 | 114/11/20 | 串接意見 API |
| T2.6 | 審核系統 | 114/11/15 | 114/11/30 | 與通知系統同步 |
| T2.7 | 通知與通訊 | 114/11/15 | 114/12/10 | 測試 WebSocket |
| T3.1 | 單元測試 | 114/10/25 | 114/11/25 | API/資料庫 CRUD |
| T3.2 | 整合測試 | 114/11/15 | 114/12/8 | 前後端串接 |
| T3.3 | 驗收測試 | 114/12/8 | 114/12/16 | 上線前測試 |
